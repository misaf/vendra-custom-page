...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-custom-page test` and `composer --working-dir=packages/vendra-custom-page analyse`.
