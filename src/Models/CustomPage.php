 ...
 * @property int $custom_page_category_id
...
final class CustomPage extends Model implements HasMedia, ShouldLogActivity, Sortable
{
    use BelongsToTenant;
    ...
    /** @use HasFactory<CustomPageFactory> */
    use HasFactory;
     ...
     */
    public function customPageCategory(): BelongsTo
    {
        return $this->belongsTo(CustomPageCategory::class);
    }
